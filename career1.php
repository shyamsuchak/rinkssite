      ...
      <div class="grid_12">
        <div class="pad-0 border-1">
          ...
          <div class="contactusarea">
            <form style="width:888px;">
              <input type="text" placeholder="Name" class="inpudfild">
              <input type="text" placeholder="Address" class="inpudfild">
              <input type="text" placeholder="E-mail" class="inpudfild">
              <input type="text" placeholder="Telephone" class="inpudfild">
              <input type="text" placeholder="City" class="inpudfild">
              <select name="contry" id="contry" class="box" style="padding:5px 10px; width:422px;">
              ...
              <input type="text" placeholder="Resume Tittle" class="inpudfild">
			  <input name="docfile" class="docfile" type="file"/>
			  <textarea placeholder="Comment " class="textarea1"></textarea> 
