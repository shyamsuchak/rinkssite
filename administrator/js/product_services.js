...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "product_services.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "product_services.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "product_services.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "product_services.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "product_services.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "product_services.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "product_services.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
...
/* BeGIN : Save Edited Record Button Function */
 function FuncSaveEditedRecord()
  {
	if(document.getElementById('gal_cat_heading').value=="")
     {
	   inlineMsg('gal_cat_heading','Please enter the Heading.');
     }
	else if(document.getElementById('gal_cat_image').value!="" && !isvalidimgfile(document.getElementById('gal_cat_image').value))
     {
       inlineMsg('gal_cat_image','<strong>Error</strong><br />Invalid image.');
     }
    else if(document.getElementById('gal_cat_sdesc').value=="")
     {
       inlineMsg('gal_cat_sdesc','Please enter Description.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "product_services.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "product_services.php";
    document.form_name.submit();
  }
 ...
 function FuncSaveNewRecord()
  { 
	if(document.getElementById('gal_cat_heading').value=="")
	 ...
	 else if(document.getElementById('gal_cat_image').value=="")
     {
       inlineMsg('gal_cat_image','Please enter the image.');
     }
	else if(document.getElementById('gal_cat_image').value!="" && !isvalidimgfile(document.getElementById('gal_cat_image').value))
     {
       inlineMsg('gal_cat_image','<strong>Error</strong><br />Invalid image.');
	...
	else
     {
       ...
       document.form_name.action = "product_services.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
