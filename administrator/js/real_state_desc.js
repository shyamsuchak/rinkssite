...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "real_state_desc.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "real_state_desc.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_desc.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_desc.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_desc.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "real_state_desc.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_desc.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
 ...
 function FuncSaveEditedRecord() //effect in administrator/jss/validmsg.php
  {
	...
	if(document.getElementById('real_state_location').value=="")
     {
	   inlineMsg('real_state_location','Please select location.');
     }
	 else if(document.getElementById('real_state_plot').value=="")
     {
        inlineMsg('real_state_plot','Please select plot.');
     }
    else if(document.getElementById('real_state_area').value=="")
     {
        inlineMsg('real_state_area','Please select area.');
     }
	 else if(document.getElementById('real_state_price').value=="")
     {
        inlineMsg('real_state_price','Please select price.');
     }
	 else if(document.getElementById('real_state_description').value=="")
     {
        inlineMsg('real_state_description','Please enter description.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "real_state_desc.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "real_state_desc.php";
    document.form_name.submit();
  }
  ...
  { 
	if(document.getElementById('real_state_location').value=="")
	...
	else
     {
       ...
       document.form_name.action = "real_state_desc.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
