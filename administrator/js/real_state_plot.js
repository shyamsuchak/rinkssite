...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "real_state_plot.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "real_state_plot.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_plot.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_plot.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_plot.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "real_state_plot.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_plot.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
 ...
 function FuncSaveEditedRecord() //effect in administrator/jss/validmsg.php
  {
	...
	if(document.getElementById('plot').value=="")
     {
	   inlineMsg('plot','Please enter plot.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "real_state_plot.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "real_state_plot.php";
    document.form_name.submit();
  }
  ...
  { 
	if(document.getElementById('plot').value=="")
	...
	else
     {
       ...
       document.form_name.action = "real_state_plot.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
