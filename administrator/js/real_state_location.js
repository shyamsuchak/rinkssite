...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "real_state_location.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "real_state_location.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_location.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_location.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_location.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "real_state_location.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_location.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
 ...
 function FuncSaveEditedRecord() //effect in administrator/jss/validmsg.php
  {
	...
	if(document.getElementById('location').value=="")
     {
	   inlineMsg('location','Please enter location.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "real_state_location.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "real_state_location.php";
    document.form_name.submit();
  }
  ...
  { 
	if(document.getElementById('location').value=="")
	...
	else
     {
       ...
       document.form_name.action = "real_state_location.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
