...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "gal_cat.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "gal_cat.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "gal_cat.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "gal_cat.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "gal_cat.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "gal_cat.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "gal_cat.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
 ...
 function FuncSaveEditedRecord()
  {
	if(document.getElementById('gal_cat_heading').value=="")
	...
	else
     {
       ...
       document.form_name.action = "gal_cat.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "gal_cat.php";
    document.form_name.submit();
  }
  ...
  { 
	if(document.getElementById('gal_cat_heading').value=="")
	...
	else
     {
       ...
       document.form_name.action = "gal_cat.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
