...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "tour_programme.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "tour_programme.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "tour_programme.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "tour_programme.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "tour_programme.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "tour_programme.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "tour_programme.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
...
/* BeGIN : Save Edited Record Button Function */
 function FuncSaveEditedRecord()
  {
	if(document.getElementById('tour_cat_name').value=="")
     {
	   inlineMsg('tour_cat_name','Please enter the Name.');
     }
	else if(document.getElementById('tour_cat_image').value!="" && !isvalidimgfile(document.getElementById('tour_cat_image').value))
     {
       inlineMsg('tour_cat_image','<strong>Error</strong><br />Invalid image.');
     }
    else if(document.getElementById('tour_cat_sdesc').value=="")
     {
       inlineMsg('tour_cat_sdesc','Please enter Description.');
     }

    else if(document.getElementById('tour_cat_price').value=="")
     {
       inlineMsg('tour_cat_price','Please enter Price.');
     }
    else if(document.getElementById('tour_cat_time').value=="")
     {
       inlineMsg('tour_cat_time','Please enter Time.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "tour_programme.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "tour_programme.php";
    document.form_name.submit();
  }
 ...
 function FuncSaveNewRecord()
  { 
	if(document.getElementById('tour_cat_name').value=="")
	 ...
	 else if(document.getElementById('tour_cat_image').value=="")
     {
       inlineMsg('tour_cat_image','Please enter the image.');
     }
	else if(document.getElementById('tour_cat_image').value!="" && !isvalidimgfile(document.getElementById('tour_cat_image').value))
     {
       inlineMsg('tour_cat_image','<strong>Error</strong><br />Invalid image.');
...
//     }
	...
	else
     {
       ...
       document.form_name.action = "tour_programme.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
