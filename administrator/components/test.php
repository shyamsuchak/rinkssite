   ...
   function ShowPageContent()
    {
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveNewData" && $PageAction =="SaveNewData")
       {  
         $SqlOrder = "SELECT MAX(newOrder) AS MaxOrder FROM k8_product_services";
         $RowOrder = mysql_fetch_object(mysql_query($SqlOrder));
         $OrderNo = $RowOrder->MaxOrder + 1;
         $SqlMaxID = "SELECT MAX(gal_cat_id) AS MaxID FROM k8_product_services";
		 ...
		 //echo $MaxID;
		  ...
		  if(is_uploaded_file($_FILES['gal_cat_image']['tmp_name']))
		  {
			 ...
			 move_uploaded_file($_FILES['gal_cat_image']['tmp_name'],'../product_services_img/'.$file); 
			 //Image_Width_fixed_Height_Resize($file,151,255,'../product_services_img','../product_services_imgthumb');  
		  }
         $SqlInsert = "INSERT INTO k8_product_services (gal_cat_id, gal_cat_heading, gal_cat_image, gal_cat_sdesc, gal_cat_catagory, gal_cat_composition, gal_cat_dosage, gal_cat_indication, gal_cat_presentation, gal_cat_warnings, gal_cat_sideeffect, product_cat_id, publish, newOrder, updtime)
         VALUES (".$MaxID.",".tosql($_POST['gal_cat_heading'], "Text").", ".tosql($file, "Text").", 
		 ".tosql($_POST['gal_cat_sdesc'], "Text").", 
		 ".tosql($_POST['gal_cat_catagory'], "Text").",".tosql($_POST['gal_cat_composition'], "Text").",
		 ".tosql($_POST['gal_cat_composition_new'], "Text").",
		 ".tosql($_POST['gal_cat_dosage'], "Text").", ".tosql($_POST['gal_cat_indication'], "Text").",
		 ".tosql($_POST['gal_cat_presentation'], "Text").",
		 ".tosql($_POST['gal_cat_warnings'], "Text").",
		 ".tosql($_POST['gal_cat_sideeffect'], "Text").",
		 ".$_POST['product_cat_id'].",
         '1', 
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveData" && $PageAction =="SaveData")
       {   
		 $ima_file=mysql_fetch_object(mysql_query("SELECT gal_cat_image FROM k8_product_services WHERE  gal_cat_id='".$DataID."'"));
		 ...
		 $SqlUpdate = "UPDATE k8_product_services SET gal_cat_heading=".tosql($_POST['gal_cat_heading'], "Text").", 
		 gal_cat_sdesc=".tosql($_POST['gal_cat_sdesc'], "Text").", gal_cat_catagory=".tosql($_POST['gal_cat_catagory'], "Text").", 
		 gal_cat_composition=".tosql($_POST['gal_cat_composition'],"Text").",
		 gal_cat_composition_new=".tosql($_POST['gal_cat_composition_new'],"Text").", 
		 gal_cat_dosage=".tosql($_POST['gal_cat_dosage'],"Text").", 
		 gal_cat_indication=".tosql($_POST['gal_cat_indication'],"Text").",
		 gal_cat_presentation=".tosql($_POST['gal_cat_presentation'],"Text").",
		 gal_cat_warnings=".tosql($_POST['gal_cat_warnings'],"Text").",
		 gal_cat_sideeffect=".tosql($_POST['gal_cat_sideeffect'],"Text").",
		 product_cat_id=".$_POST['product_cat_id']." WHERE gal_cat_id='".$DataID."';";
         //die($SqlUpdate);
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSortUp" && $PageAction =="SortUp")
       {
         $SqlOrder = "SELECT newOrder FROM k8_product_services WHERE gal_cat_id='".$DataID."';";
         $RowOrder = mysql_fetch_object(mysql_query($SqlOrder));
         $OrderNo = $RowOrder->newOrder - 1;
         $SqlUpdate01 = "UPDATE k8_product_services SET newOrder = newOrder + 1 WHERE newOrder='".$OrderNo."';";
         mysql_query($SqlUpdate01);
         $SqlUpdate02="UPDATE k8_product_services SET newOrder = newOrder - 1 WHERE gal_cat_id='".$DataID."';";
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionEnableRecord" && $PageAction =="EnableRecord")
       {
         $SqlUpdate01 = "UPDATE k8_product_services SET publish='1' WHERE gal_cat_id='".$DataID."';";
         mysql_query($SqlUpdate01);
         tep_redirect(tep_href_link($ActionPath));
       }                 
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionDisableRecord" && $PageAction =="DisableRecord")
       {
         $SqlUpdate01 = "UPDATE k8_product_services SET publish='0' WHERE gal_cat_id='".$DataID."';";
         mysql_query($SqlUpdate01);
         tep_redirect(tep_href_link($ActionPath));
       }                 
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActEnableAllRecord" && $PageAction =="EnableAllRecord")
       {
         ...
         for($i=0;$i < $Count; $i++)
          {     
             $SqlUpdate01 = "UPDATE k8_product_services SET publish='1' WHERE gal_cat_id='".$checkitem[$i]."';";
            mysql_query($SqlUpdate01);
          }
         tep_redirect(tep_href_link($ActionPath));
       }
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActDisableAllRecord" && $PageAction =="DisableAllRecord")
       {
         ...
         for($i=0;$i < $Count; $i++)
          {     
           $SqlUpdate01 = "UPDATE k8_product_services SET publish='0' WHERE gal_cat_id='".$checkitem[$i]."';";
            mysql_query($SqlUpdate01);
          }               
         tep_redirect(tep_href_link($ActionPath));
       }
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionDelete" && $PageAction =="Delete")
       {
         ...
         for($i=0;$i < $Count; $i++)
          { 
			$sqlgal="SELECT gal_img_image FROM k8_product_services WHERE gal_cat_id='".$checkitem[$i]."'";
			//echo "sqlgal = ".$sqlgal."<br>";
			$resgal=mysql_query($sqlgal);
			while($ima_file1=mysql_fetch_object($resgal))
			{
			// sudhakar @unlink('../galleryimg/'.$ima_file1->gal_img_image);
			 //@unlink('../galleryimgthumb/'.$ima_file1->gal_img_image);
			 $SqlDelete1 = "DELETE FROM k8_product_services WHERE gal_img_id = '".$ima_file1->gal_img_id."';";
			 //echo "SqlDelete1 = ".$SqlDelete1."<br>";
             mysql_query($SqlDelete1);
			 }
			 
			 $ima_file=mysql_fetch_object(mysql_query("SELECT gal_cat_image FROM k8_product_services WHERE  gal_cat_id='".$checkitem[$i]."'"));
			 @unlink('../product_services_img/'.$ima_file->gal_cat_image);
			 @unlink('../product_services_imgthumb/'.$ima_file->gal_cat_image);
			 $SqlDelete = "DELETE FROM k8_product_services WHERE gal_cat_id='".$checkitem[$i]."';";
...
{
  $drop = '';
  $SqlEditRecord=mysql_query("SELECT * FROM k8_product_category;");
   $select = '';
  
  $drop.='<select>';
  while($RowEditRecord=mysql_fetch_array($SqlEditRecord))
  {
  if(isset($id)&&($RowEditRecord['product_cat_id']==$id))
  $select = 'selected';
  else
  $select = '';
  
  $drop.='<option value='.$RowEditRecord['product_cat_id'].' selected='.$select .'>'.$RowEditRecord['product_cat_name'].'</option>'; 
  ...
  return $drop;
   ...
   function AddNewNewsRecords()
    {
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
			  ...
			  <tr>
				...
				<tr>
                  <td class="label-text" align="left" valign="top">Benefit</td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_sdesc" id="gal_cat_sdesc" style="width:57%; height:100px;" class="input_box" required></textarea></td>
                </tr>
				...
				<!--<tr>
                  <td class="label-text" align="left" valign="top"> Catagory </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_catagory" id="gal_cat_catagory" style="width:57%; height:100px;" class="input_box" required></textarea></td>
                </tr>-->
				
				<tr>
                  <td class="label-text" align="left" valign="top">Brand Name</td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_composition_new" id="gal_cat_composition_new" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
				
				
				<tr>
                  <td class="label-text" align="left" valign="top">Composition </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_composition" id="gal_cat_composition" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top">Dosage </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_dosage" id="gal_cat_dosage" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top">Indication </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_indication" id="gal_cat_indication" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
				...
				<tr>
                  <td class="label-text" align="left" valign="top">Warnings </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_warnings" id="gal_cat_warnings" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top">Side Effect </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_sideeffect" id="gal_cat_sideeffect" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top">Store Condition </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_presentation" id="gal_cat_presentation" style="width:57%; height:100px;" class="input_box" required></textarea>
				  </td>
                </tr>
	  ...
	  <script type="text/javascript">
	    window.onload = function()
	     {
		   var editor=CKEDITOR.replace( "gal_cat_composition" );
		   //var editor2=CKEDITOR.replace( "gal_cat_composition_new" );
	     };
      </script>';  
      return $fcontent;
    } 
   ...
   function EditArticlesRecords($CfgGroupID,$DataID)
    {
      $SqlEditRecord="SELECT * FROM k8_product_services WHERE  gal_cat_id='".$DataID."';";
      $RowEditRecord=mysql_fetch_object(mysql_query($SqlEditRecord));
	  
	  /* Thumbnail view Start */
	  if($RowEditRecord->gal_cat_image!='' && file_exists('../product_services_imgthumb/'.$RowEditRecord->gal_cat_image))
		$imagepath='../product_services_imgthumb/'.$RowEditRecord->gal_cat_image;
	  else
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
			  ...
			  <tr>
                  ...
                  <td class="label-text" align="center" style="width:10px">:</td>
                  <td class="label-text" align="left" style="width:70%">';
				  $fcontent.=$this->cat_drop($RowEditRecord->product_cat_id);
				  $fcontent.='</td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <input type="file" name="gal_cat_image" id="gal_cat_image" size="30" style="width:57%;" class="input_box" value ="'.$RowEditRecord->gal_cat_image.'">
				  <br>(Width:151px X Height:255px)
				...
				<!--<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_catagory" id="gal_cat_catagory" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_cat_catagory.'</textarea>
				  </td>
                </tr>-->
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_composition_new" id="gal_cat_composition_new" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_cat_composition_new.'</textarea>
				  </td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top">Utility of Product </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_composition" id="gal_cat_composition" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_cat_composition.'</textarea>
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_dosage" id="gal_cat_dosage" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_cat_dosage.'</textarea>
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_indication" id="gal_cat_indication" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_cat_indication.'</textarea>
				  </td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top">Presentation </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_cat_presentation" id="gal_cat_presentation" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_cat_presentation.'</textarea>
				  </td>
                </tr>
   ...
   function ViewArticlesRecords($CfgGroupID,$DataID)
    {
      $SqlViewRecord="SELECT * FROM k8_product_services WHERE  gal_cat_id='".$DataID."';";
      $RowViewRecord=mysql_fetch_object(mysql_query($SqlViewRecord));
	  /* Image view Start */
	  if($RowViewRecord->gal_cat_image!='' && file_exists('../product_services_imgthumb/'.$RowViewRecord->gal_cat_image))
		$imagepath='../product_services_imgthumb/'.$RowViewRecord->gal_cat_image;
	  else
		$imagepath='images/no-img.jpg';
	/* Image View  end */
      $fcontent ='
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="1" >
				...
				<!--<tr>
                  <td class="label-text" align="left" valign="top" style="background-color:#eeeeee; padding:0 10px 0 10px;">'.Catagory.':</td>
                  <td class="label-text" align="left" valign="top" style="width:70%; background-color:#eeeeee; padding:0 10px 0 10px;">
				  '.$RowViewRecord->gal_cat_catagory.'</td>
                </tr>-->
   ...
   function ViewNewsRecords($CfgGroupID)
    {
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        $SqlTotCount = "SELECT COUNT(gal_cat_id) AS TotalRecord FROM k8_product_services";
...
<!-- js and css code -->
           <tr>
             ...
             <table id="table-1" width="100%" border="0" cellspacing="0" cellpadding="0" >
               ...
               $SqlOrder = "SELECT MAX(newOrder) AS MaxOrder , MIN(newOrder) AS MinOrder FROM k8_product_services";
               $RowOrder = mysql_fetch_object(mysql_query($SqlOrder));
               $SqlRecord = "SELECT * FROM k8_product_services ORDER BY newOrder ASC ".$PageLimit.";";
               $RstRecord=mysql_query($SqlRecord);
               while($RowRecord=mysql_fetch_object($RstRecord))
                {  
				  if($RowRecord->gal_cat_image!='' && file_exists('../product_services_imgthumb/'.$RowRecord->gal_cat_image))
					$imagepath='../product_services_imgthumb/'.$RowRecord->gal_cat_image;
				  else
					$imagepath='images/no-img.jpg';
                  ...
                  <tr class="text_tr" id='.$SlNo.'>
					...
					<td>'.$RowRecord->gal_cat_sdesc.'</td>
					<!--<td>'.$RowRecord->gal_cat_catagory.'</td>-->
					<!--<td>'.$RowRecord->gal_cat_composition.'</td>-->
					<td>'.$RowRecord->gal_cat_dosage.'</td>
					<td>'.$RowRecord->gal_cat_indication.'</td>
					<td>'.$RowRecord->gal_cat_presentation.'</td>
