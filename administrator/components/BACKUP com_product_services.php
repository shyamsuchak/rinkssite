       ...
       {  
         ...
         $MaxID = $RowMaxID->MaxID + 1;
		  ...
		  if(is_uploaded_file($_FILES['gal_cat_image']['tmp_name']))
		  {
			 ...
			 Image_Width_fixed_Height_Resize($file,186,186,'../product_services_img','../product_services_imgthumb');  
		  }
         $SqlInsert = "INSERT INTO k8_product_services (gal_cat_id, gal_cat_heading, gal_cat_image, gal_cat_sdesc, publish, newOrder, updtime)
