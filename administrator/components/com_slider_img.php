   ...
   function ShowPageContent()
    {
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveNewData" && $PageAction =="SaveNewData")
       {  
         ...
         $SqlInsert = "INSERT INTO ".TBL_GALLERY." (gal_img_id, gal_cat_id, hotel_name_cat, gal_img_heading, gal_img_image, gal_img_sdesc, publish, newOrder, updtime)
         VALUES (".$MaxID.", ".tosql($_POST['gal_cat_id'], "Number").", ".tosql($_POST['hotel_name_cat'], "Text").", ".tosql($_POST['gal_img_heading'], "Text").", ".tosql($file, "Text").", 
		 ".tosql($_POST['gal_img_sdesc'], "Text").",'1', ".tosql($OrderNo, "Number").", now());";
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveData" && $PageAction =="SaveData")
       {   
		 ...
		 $_REQUEST['galcat_id']=$_REQUEST['gal_cat_id'];
		 $SqlUpdate = "UPDATE ".TBL_GALLERY." SET gal_cat_id=".tosql($_POST['gal_cat_id'], "Number").", hotel_name_cat=".tosql($_POST['hotel_name_cat'], "Text").", gal_img_heading=".tosql($_POST['gal_img_heading'], "Text").", 
		 gal_img_sdesc=".tosql($_POST['gal_img_sdesc'], "Text").", gal_img_image=".tosql($file, "Text")." WHERE gal_img_id='".$DataID."';";
         //die($SqlUpdate);
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2" >
			    <tr>
                  <td class="label-text" align="left">'.HOTEL_NAME.'</td>
                  <td class="label-text" align="center" style="width:10px">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <select name="hotel_name_cat" id="hotel_name_cat" style="width:270px;">
					  <option value="Artland Hotel">Artland Hotel</option>
					  <option value="Ashamukti Hotel">Ashamukti Hotel</option>
					  <option value="Mukti Hotel">Mukti Hotel</option>
				</select></td>
                </tr>
				<tr>
                  <td class="label-text" align="left" valign="top">'.CONSTANT_CATNAME.'</td>
                  <td class="label-text" align="center" valign="top" style="width:10px">:</td>
                  <td class="label-text" align="left" valign="top" style="width:70%">
				  ...
				  {
				  $sel='';
				  if($fetchedit->gal_cat_id==$_REQUEST['galcat_id'])
				...
				<tr>
                  ...
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_img_sdesc" id="gal_img_sdesc" style="width:57%; height:100px;" class="input_box"></textarea></td>
                </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2" >
				...
				<tr>
                  <td class="label-text" align="left">'.CONSTANT_CATNAME.'</td>
                  <td class="label-text" align="center" style="width:10px">:</td>
                  <td class="label-text" align="left" style="width:70%">
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="gal_img_sdesc" id="gal_img_sdesc" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->gal_img_sdesc.'</textarea>
				  </td>
                </tr>
             ...
             <table id="table-1" width="100%" border="0" cellspacing="0" cellpadding="0" >
               <tr class="heading_tr">
                 ...
                 <th align="center" style="width:60px;">'.CONSTANT_VIEW_HEADING_SERIAL_NUMBER.'</th>
				  <th>'.VIEW_HOTEL_NAME.'</th>
				 <th>'.CONSTANT_CATNAME.'</th>
				 <th>'.CONSTANT_NAME.'</th>
               ...
               while($RowRecord=mysql_fetch_object($RstRecord))
                {  
                  ...
                  <tr class="text_tr" id="'.$SlNo.'">				  		  
					...
					<td>'.$RowRecord->hotel_name_cat.'</td>
