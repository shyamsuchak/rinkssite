...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "real_state_price.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "real_state_price.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_price.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "real_state_price.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_price.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "real_state_price.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "real_state_price.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
 ...
 function FuncSaveEditedRecord() //effect in administrator/jss/validmsg.php
  {
	...
	if(document.getElementById('price').value=="")
     {
	   inlineMsg('price','Please enter price.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "real_state_price.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "real_state_price.php";
    document.form_name.submit();
  }
  ...
  { 
	if(document.getElementById('price').value=="")
	...
	else
     {
       ...
       document.form_name.action = "real_state_price.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
