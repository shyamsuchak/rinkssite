...
function FuncRecordSortUp(RecordID)
 {
   ...
   document.form_name.action = "feedback.php?Action=ActionSortUp";
   document.form_name.submit();
 }
...
function FuncRecordSortDown(RecordID)
 {
   ...
   document.form_name.action = "feedback.php?Action=ActionSortDown";
   document.form_name.submit();
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "feedback.php?Action=ActionEnableRecord";
      document.form_name.submit();
    }
 }
   ...
   if (chk==true)
    {
      ...
      document.form_name.action = "feedback.php?Action=ActionDisableRecord";
      document.form_name.submit();
    }
 }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "feedback.php?Action=ActEnableAllRecord";
          document.form_name.submit();
        }
     }
  }
       ...
       if (chk==true)
        {
          ...
          document.form_name.action = "feedback.php?Action=ActDisableAllRecord";
          document.form_name.submit();
        }
     }
  }
     ...
     {       
       ...
       if (chk==true)
        {                            
          ...
          document.form_name.action = "feedback.php?Action=ActionDelete";
          document.form_name.submit();
        }
     }
  }
 ...
 function FuncSaveEditedRecord() //effect in administrator/jss/validmsg.php
  {
	...
	if(document.getElementById('feed_name').value=="")
     {
	   inlineMsg('feed_name','Please enter your name.');
     }
	 else if(document.getElementById('feed_emailid').value=="")
     {
	    inlineMsg('feed_emailid','Please enter your email.');
     }
	else if(document.getElementById('feed_emailid').value!="" && !isvalidemail(document.getElementById('feed_emailid').value))
     {
        inlineMsg('feed_emailid','<strong>Error</strong><br />Invalid email.');
     }
	 else if(document.getElementById('feed_contact').value=="")
     {
        inlineMsg('feed_contact','Please enter your contact.');
     }
	 else if(document.getElementById('feed_contact').value!="" && !isvalidcontact(document.getElementById('feed_contact').value))
     {
        inlineMsg('feed_contact','<strong>Error</strong><br />Invalid contact.');
     }
	else if(document.getElementById('feed_image').value!="" && !isvalidimgfile(document.getElementById('feed_image').value))
     {
        inlineMsg('feed_image','<strong>Error</strong><br />Invalid image.');
     }
    else if(document.getElementById('feed_comment').value=="")
     {
        inlineMsg('feed_comment','Please enter your comment.');
     }
	else
     {
       document.getElementById("PageAction").value = "SaveData";   
       document.form_name.action = "feedback.php?Action=ActionSaveData";
       document.form_name.submit();
     }
  }
 ...
 function FuncAddNewRecord()
  {
    ...
    document.form_name.action = "feedback.php";
    document.form_name.submit();
  }
  ...
  { 
	if(document.getElementById('feed_name').value=="")
	...
	else
     {
       ...
       document.form_name.action = "feedback.php?Action=ActionSaveNewData";
       document.form_name.submit();
     }
  }
