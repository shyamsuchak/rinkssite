...
class LoadPageContentClass
 {
   function ShowPageContent()
    {
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveNewData" && $PageAction =="SaveNewData")
       {  
         $SqlOrder = "SELECT MAX(newOrder) AS MaxOrder FROM k8_tour_programme";
         $RowOrder = mysql_fetch_object(mysql_query($SqlOrder));
         $OrderNo = $RowOrder->MaxOrder + 1;
         $SqlMaxID = "SELECT MAX(tour_cat_id) AS MaxID FROM k8_tour_programme";
         $RowMaxID = mysql_fetch_object(mysql_query($SqlMaxID));
         $MaxID = $RowMaxID->MaxID + 1;
		  extract($_POST);
		   $file='';
		  if(is_uploaded_file($_FILES['tour_cat_image']['tmp_name']))
		  {
		     $ext = ".".end(explode('.', $_FILES['tour_cat_image']['name']));
			 $imgname=rand();
			 $file=$MaxID.$ext;
			 //$file=time().$_FILES['gal_cat_image']['name'];
			 move_uploaded_file($_FILES['tour_cat_image']['tmp_name'],'../tour_programme_img/'.$file); 
			 Image_Width_fixed_Height_Resize($file,186,186,'../tour_programme_img','../tour_programme_imgthumb');  
		  }
         $SqlInsert = "INSERT INTO k8_tour_programme (tour_cat_id, tour_cat_name, tour_cat_image, tour_cat_sdesc, tour_cat_time, tour_cat_price,  publish, newOrder, updtime)
         VALUES (".$MaxID.",".tosql($_POST['tour_cat_name'], "Text").", ".tosql($file, "Text").", ".tosql($_POST['tour_cat_sdesc'], "Text").", ".tosql($_POST['tour_cat_time'], "Text").", ".tosql($_POST['tour_cat_price'], "Text").",'1', 
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveData" && $PageAction =="SaveData")
       {   
		 $ima_file=mysql_fetch_object(mysql_query("SELECT tour_cat_image FROM k8_tour_programme WHERE  tour_cat_id='".$DataID."'"));
	       $file=$ima_file->tour_cat_image;
		   if(is_uploaded_file($_FILES['tour_cat_image']['tmp_name']))
		   {			 
		     $ext = ".".end(explode('.', $_FILES['tour_cat_image']['name']));
			 $file=$DataID.$ext;
		 ...
		 $SqlUpdate = "UPDATE k8_tour_programme SET tour_cat_name=".tosql($_POST['tour_cat_name'], "Text").", 
		 tour_cat_sdesc=".tosql($_POST['tour_cat_sdesc'], "Text").", 
		 tour_cat_time=".tosql($_POST['tour_cat_time'], "Text").", tour_cat_price=".tosql($_POST['tour_cat_price'], "Text").", tour_cat_image=".tosql($file, "Text")." WHERE tour_cat_id='".$DataID."';";
         //die($SqlUpdate);
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSortUp" && $PageAction =="SortUp")
       {
         $SqlOrder = "SELECT newOrder FROM k8_tour_programme WHERE tour_cat_id='".$DataID."';";
         $RowOrder = mysql_fetch_object(mysql_query($SqlOrder));
         $OrderNo = $RowOrder->newOrder - 1;
         $SqlUpdate01 = "UPDATE k8_tour_programme SET newOrder = newOrder + 1 WHERE newOrder='".$OrderNo."';";
         mysql_query($SqlUpdate01);
         $SqlUpdate02="UPDATE k8_tour_programme SET newOrder = newOrder - 1 WHERE tour_cat_id='".$DataID."';";
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionEnableRecord" && $PageAction =="EnableRecord")
       {
         $SqlUpdate01 = "UPDATE k8_tour_programme SET publish='1' WHERE tour_cat_id='".$DataID."';";
         mysql_query($SqlUpdate01);
         tep_redirect(tep_href_link($ActionPath));
       }                 
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionDisableRecord" && $PageAction =="DisableRecord")
       {
         $SqlUpdate01 = "UPDATE k8_tour_programme SET publish='0' WHERE tour_cat_id='".$DataID."';";
         mysql_query($SqlUpdate01);
         tep_redirect(tep_href_link($ActionPath));
       }                 
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActEnableAllRecord" && $PageAction =="EnableAllRecord")
       {
         ...
         for($i=0;$i < $Count; $i++)
          {     
             $SqlUpdate01 = "UPDATE k8_tour_programme SET publish='1' WHERE tour_cat_id='".$checkitem[$i]."';";
            mysql_query($SqlUpdate01);
          }
         tep_redirect(tep_href_link($ActionPath));
       }
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActDisableAllRecord" && $PageAction =="DisableAllRecord")
       {
         ...
         for($i=0;$i < $Count; $i++)
          {     
           $SqlUpdate01 = "UPDATE k8_tour_programme SET publish='0' WHERE tour_cat_id='".$checkitem[$i]."';";
            mysql_query($SqlUpdate01);
          }               
         tep_redirect(tep_href_link($ActionPath));
       }
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionDelete" && $PageAction =="Delete")
       {
         ...
         for($i=0;$i < $Count; $i++)
          { 
			$sqlgal="SELECT gal_img_image FROM k8_tour_programme WHERE tour_cat_id='".$checkitem[$i]."'";
			...
			// sudhakar @unlink('../galleryimg/'.$ima_file1->gal_img_image);
			 ...
			 #$SqlDelete1 = "DELETE FROM k8_tour_programme WHERE tour_img_id = '".$ima_file1->gal_img_id."';";
			 //echo "SqlDelete1 = ".$SqlDelete1."<br>";
             #mysql_query($SqlDelete1);
			 }
			 
			 $ima_file=mysql_fetch_object(mysql_query("SELECT tour_cat_image FROM k8_tour_programme WHERE  tour_cat_id='".$checkitem[$i]."'"));
			 @unlink('../tour_programme_img/'.$ima_file->tour_cat_image);
			 @unlink('../tour_programme_imgthumb/'.$ima_file->tour_cat_image);
			 $SqlDelete = "DELETE FROM k8_tour_programme WHERE tour_cat_id='".$checkitem[$i]."';";
	...
	{
		CKEDITOR.replace("tour_cat_sdesc");
	};
</script>';
      return $pcontent;
    }     
   function AddNewNewsRecords()
    {
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2" >
				...
				<tr>
				  ...
				  <input type="text" name="tour_cat_name" id="tour_cat_name" value="" size="30" style="width:57%;" class="input_box" >
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <input type="file" name="tour_cat_image" id="tour_cat_image" size="30" style="width:57%;" class="input_box" >
				   <br>(Width:706px X Height:445px)
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="tour_cat_sdesc" id="tour_cat_sdesc" style="width:57%; height:100px;" class="input_box"></textarea></td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top"> Price </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="tour_cat_price" id="tour_cat_price" style="width:57%; height:100px;" class="input_box"></textarea></td>
                </tr>

				<tr>
                  <td class="label-text" align="left" valign="top"> Time </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="tour_cat_time" id="tour_cat_time" style="width:57%; height:100px;" class="input_box"></textarea></td>
                </tr>
	  ...
	  <script type="text/javascript">
	    window.onload = function()
	     {
		   var editor=CKEDITOR.replace( "tour_cat_sdesc" );
	     };
      </script>'; 
      return $fcontent;
    } 
   ...
   function EditArticlesRecords($CfgGroupID,$DataID)
    {
      $SqlEditRecord="SELECT * FROM k8_tour_programme WHERE  tour_cat_id='".$DataID."';";
      $RowEditRecord=mysql_fetch_object(mysql_query($SqlEditRecord));
	  
	  /* Thumbnail view Start */
	  if($RowEditRecord->tour_cat_image!='' && file_exists('../tour_programme_img/'.$RowEditRecord->tour_cat_image))
		$imagepath='../tour_programme_img/'.$RowEditRecord->tour_cat_image;
	  else
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2" >
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <input type="text" name="tour_cat_name" id="tour_cat_name" value="'.$RowEditRecord->tour_cat_name.'" size="30" style="width:57%;" 
				  class="input_box" >
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <input type="file" name="tour_cat_image" id="tour_cat_image" size="30" style="width:57%;" class="input_box" value ="'.$RowEditRecord->tour_cat_image.'">
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="tour_cat_sdesc" id="tour_cat_sdesc" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->tour_cat_sdesc.'</textarea>
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="tour_cat_price" id="tour_cat_price" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->tour_cat_price.'                  </textarea>
				  </td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
				  <textarea name="tour_cat_time" id="tour_cat_time" style="width:57%; height:100px;" class="input_box">'.$RowEditRecord->tour_cat_time.'                  </textarea>
				  </td>
                </tr>
   ...
   function ViewArticlesRecords($CfgGroupID,$DataID)
    {
      $SqlViewRecord="SELECT * FROM k8_tour_programme WHERE  tour_cat_id='".$DataID."';";
      $RowViewRecord=mysql_fetch_object(mysql_query($SqlViewRecord));
	  /* Image view Start */
	  if($RowViewRecord->tour_cat_image!='' && file_exists('../tour_programme_img/'.$RowViewRecord->tour_cat_image))
		$imagepath='../tour_programme_img/'.$RowViewRecord->tour_cat_image;
	  else
		$imagepath='images/no-img.jpg';
	/* Image View  end */
      $fcontent ='
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="1" >
				<tr>
				  ...
				  '.$RowViewRecord->tour_cat_name.'</td>
                </tr>
				...
				<tr>
                  ...
                  <td class="label-text" align="left" valign="top" style="width:70%; background-color:#eeeeee; padding:0 10px 0 10px;">
				  '.$RowViewRecord->tour_cat_sdesc.'</td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top" style="background-color:#eeeeee; padding:0 10px 0 10px;">Price :</td>
                  <td class="label-text" align="left" valign="top" style="width:70%; background-color:#eeeeee; padding:0 10px 0 10px;">
				  '.$RowViewRecord->tour_cat_price.'</td>
                </tr>
				
				<tr>
                  <td class="label-text" align="left" valign="top" style="background-color:#eeeeee; padding:0 10px 0 10px;">Time :</td>
                  <td class="label-text" align="left" valign="top" style="width:70%; background-color:#eeeeee; padding:0 10px 0 10px;">
				  '.$RowViewRecord->tour_cat_time.'</td>
                </tr>				
   ...
   function ViewNewsRecords($CfgGroupID)
    {
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        $SqlTotCount = "SELECT COUNT(tour_cat_id) AS TotalRecord FROM k8_tour_programme";
...
<!-- js and css code -->
           <tr>
             ...
             <table id="table-1" width="100%" border="0" cellspacing="0" cellpadding="0" >
               ...
               $RowOrder = mysql_fetch_object(mysql_query($SqlOrder));
               $SqlRecord = "SELECT * FROM k8_tour_programme ORDER BY newOrder ASC ".$PageLimit.";";
               $RstRecord=mysql_query($SqlRecord);
               while($RowRecord=mysql_fetch_object($RstRecord))
                {  
				  if($RowRecord->tour_cat_image!='' && file_exists('../tour_programme_img/'.$RowRecord->tour_cat_image))
					$imagepath='../tour_programme_img/'.$RowRecord->tour_cat_image;
				  else
					$imagepath='images/no-img.jpg';
					
					
				  $sdesc=$RowRecord->tour_cat_sdesc;
				  #echo $sdesc;
				  #echo mb_substr($sdesc, 0, 10);
				  	
				  
				  $fcontent .= '
                  <tr class="text_tr" id='.$SlNo.'>
                    <td><input type="checkbox" name="checkitem[]" id="checkitem" onclick="CheckIndividual(this);" value="'.$RowRecord->tour_cat_id.'" 
					title="'.CONSTANT_CHECKBOX_TITLE_CAPTION.'" ></td>
                    <td align="center">'.$SlNo.'</td>
					<td>'.$RowRecord->tour_cat_name.'</td>
					<td>'.mb_substr($RowRecord->tour_cat_sdesc, 0, 100).'</td>
					<td>'.$RowRecord->tour_cat_time.'</td>
					<td>'.$RowRecord->tour_cat_price.'</td>
					<td align="center"><img src='.$imagepath.' width=30 height=30 ></td>
					<td align="center"><a href="javascript: SingleFuncViewRecord('.$RowRecord->tour_cat_id.');" title="'.CONSTANT_BUTTON_TEXT_VIEW.'"><img 
					title="'.CONSTANT_BUTTON_TEXT_VIEW.'" src="images/button/articles/view.png" border="0" /></a></td>
                   <td align="center"><a href="javascript: SingleFuncEditRecord('.$RowRecord->tour_cat_id.');" title="'.CONSTANT_BUTTON_TEXT_EDIT.'"><img 
				   title="'.CONSTANT_BUTTON_TEXT_EDIT.'" src="images/button/articles/edit.png" border="0" /></a></td>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        if($RowRecord->newOrder != $RowOrder->MinOrder)
                         {
                           $fcontent .= '<a href="javascript: FuncRecordSortUp('.$RowRecord->_cat_id.');" title="'.CONSTANT_BUTTON_TEXT_SORT_UP.'" ><img 
                        ...
                        if($RowRecord->newOrder != $RowOrder->MaxOrder)
                         {
                           $fcontent .= '<a href="javascript: FuncRecordSortDown('.$RowRecord->tour_cat_id.');" title="'.CONSTANT_BUTTON_TEXT_SORT_DOWN.'" ><img 
                    ...
                    if($RowRecord->publish == "1")
                     {
                       $fcontent .= '<a href="javascript: FuncDisableRecord('.$RowRecord->tour_cat_id.');" title="'.CONSTANT_BUTTON_TEXT_ENABLE.'"><img 
					   src="images/button/articles/enable-sml.png" title="'.CONSTANT_BUTTON_TEXT_ENABLE.'" border="0" ></a>';
                     }
                    else
                     {
                       $fcontent .= '<a href="javascript: FuncEnableRecord('.$RowRecord->tour_cat_id.');" title="'.CONSTANT_BUTTON_TEXT_DISABLE.'"><img 
					   src="images/button/articles/disable-sml.png" title="'.CONSTANT_BUTTON_TEXT_DISABLE.'" border="0" ></a>';
                     }
                    $fcontent .= '</td>  
                    <!--td align="right">'.$RowRecord->tour_cat_id.'</td-->
                  </tr>';
                  $SlNo++;
                }
               $fcontent .= '
