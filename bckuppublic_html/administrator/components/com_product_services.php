   ...
   function ShowPageContent()
    {
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveNewData" && $PageAction =="SaveNewData")
       {  
         ...
         $SqlInsert = "INSERT INTO k8_product_services (gal_cat_id, gal_cat_heading, gal_cat_image, gal_cat_sdesc, gal_cat_catagory, gal_cat_composition, gal_cat_dosage, gal_cat_indication, gal_cat_presentation, publish, newOrder, updtime)
      ...
      if(isset($_REQUEST['Action']) && $_REQUEST['Action'] == "ActionSaveData" && $PageAction =="SaveData")
       {   
		 ...
		 gal_cat_image=".tosql($file, "Text")." WHERE gal_cat_id='".$DataID."';";
		// echo $SqlUpdate;exit;
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2" >
				...
				<tr>
                  <td class="label-text" align="left" valign="top">Utility of Products </td>
                  <td class="label-text" align="center" style="width:10px" valign="top">:</td>
                  <td class="label-text" align="left" style="width:70%">
